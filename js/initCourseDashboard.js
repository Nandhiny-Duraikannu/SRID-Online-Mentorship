$(function() {
    function init() {
        ...
        if (status === "tutor") {
            buttonDom
                .append('<a class="row waves-effect waves-light btn col s12">lecture videos</a>')
                .append('<a class="row waves-effect waves-light btn col s12">create quiz</a>')
            ...
            buttonDom
                ...
                .append('<a class="row waves-effect waves-light btn col s12">take quiz</a>')
                .append('<a class="row waves-effect waves-light btn col s12">forum</a>')
